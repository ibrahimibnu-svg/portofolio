...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    localStorage.setItem('guestbook', JSON.stringify([...existing, newEntry]));
    setGuestbook([...existing, newEntry]);
    setName('');
    setEmail('');
    setMessage('');
    ...
    <section className={styles.contact}>
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <a
            href="https://wa.me/6289519455205"
            target="_blank"
            rel="noreferrer"
          ...
          <a
            href="https://www.instagram.com/ibrahimibnoe/"
            target="_blank"
            rel="noreferrer"
            className={styles.socialBtn}
          ...
          <a
            href="mailto:i30007632@gmail.com"
            target="_blank"
            rel="noreferrer"
            className={styles.socialBtn}
            aria-label="Email"
        ...
        {guestbook.length > 0 && (
          <div className={styles.guestbookSection}>
            <div className={styles.guestbookHeader}>
              <h2 className={styles.sectionTitle}>Buku Tamu</h2>
              ...
              {guestbook.map((entry, index) => (
                <div key={index} className={styles.guestCard}>
                  <div className={styles.guestHeader}>
                    <span className={styles.guestName}>{entry.name}</span>
                    <span className={styles.guestDate}>{entry.date}</span>
                  </div>
